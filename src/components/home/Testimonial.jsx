...
const Testimonial = () => {
  ...
  return (
    ...
    <Title title = "Don't just take our words" description="Here's what our users say about us. We're always looking for ways to improve. If you have any feedback, we'd love to hear it."/>
    </div>
